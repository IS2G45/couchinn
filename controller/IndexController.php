...
class IndexController {
     ...
     * @param unknown $data
     */
    private function paginador_process_searchTipo( $idTipoCouch, $pagina = 1) {
    ...
    private function paginador_process_searchProvincia( $idProvincia, $pagina = 1) {
    ...
    private function paginador_process_searchTipoDescripcion($idTipo, $descripcion, $pagina = 1) {
    	$total = CouchModel::getInstance()->countCouchsByTipoDescripcion(array("idTipoCouch" => $idTipo, "descripcion" => "%$descripcion%"));
    	$limit = 9; //cantidad de paginas a mostrar
    	$paginas = ceil($total / $limit); //cantidad de paginas en el sistema
    	$offset = ($pagina - 1) * $limit;
    	$couchinns = CouchModel::getInstance()->searchCouchsByTipoDescripcion(array(
    			"idTipoCouch" => $idTipo,
    			"descripcion" => "%$descripcion%",
    			"limit" => $limit,
    			"offset" => $offset
    ...
    private function paginador_process_searchTipoProvincia( $idTipo ,$idProv, $pagina = 1) {
    	$total = CouchModel::getInstance()->countCouchsByTipoProvincia(array("idTipoCouch" => $idTipo, "idProvincia" => $idProv));
    	$limit = 9; //cantidad de paginas a mostrar
    	$paginas = ceil($total / $limit); //cantidad de paginas en el sistema
    	$offset = ($pagina - 1) * $limit;
    	$couchinns = CouchModel::getInstance()->searchCouchsByTipoProvincia(array(
    			"idTipoCouch" => $idTipo,
    			"idProvincia" => $idProv,
    			"limit" => $limit,
    			"offset" => $offset
    ...
    private function paginador_process_searchTipoLugar( $idTipo, $idProv, $idCdad, $pagina = 1) {
    	$total = CouchModel::getInstance()->countCouchsByTipoLugar(array("idTipoCouch" => $idTipo, "idProvincia" => $idProv, "idCiudad" => $idCdad));
    	$limit = 9; //cantidad de paginas a mostrar
    	$paginas = ceil($total / $limit); //cantidad de paginas en el sistema
    	$offset = ($pagina - 1) * $limit;
    	$couchinns = CouchModel::getInstance()->searchCouchsByTipoLugar(array(
    			"idTipoCouch" => $idTipo,
    			"idProvincia" => $idProv,
    			"idCiudad" => $idCdad,
    			"limit" => $limit,
    ...
    private function paginador_process_searchProvCdadDescrip( $idProv, $idCdad, $descripcion, $pagina = 1) {
    	$total = CouchModel::getInstance()->countCouchsByProvCdadDescrip(array(
    			"idProvincia" => $idProv,
    			"idCiudad" => $idCdad,
    			"descripcion" => "%$descripcion%"
    	));
    	...
    	$couchinns = CouchModel::getInstance()->searchCouchsByProvCdadDescrip(array(
    			"idProvincia" => $idProv,
    			"idCiudad" => $idCdad,
    			"descripcion" => "%$descripcion%",
    			"limit" => $limit,
    ...
    private function paginador_process_searchProvDescrip( $idProv, $descripcion, $pagina = 1) {
    	$total = CouchModel::getInstance()->countCouchsByProvDescrip(array(
    			"idProvincia" => $idProv,
    			"descripcion" => "%$descripcion%"
    	));
    	$limit = 9; //cantidad de paginas a mostrar
    	...
    	$couchinns = CouchModel::getInstance()->searchCouchsByProvDescrip(array(
    			"idProvincia" => $idProv,
    			"descripcion" => "%$descripcion%",
    			"limit" => $limit,
    			"offset" => $offset
    ...
    private function paginador_process_searchTipoProvDescrip($idTipo, $idProv, $descripcion, $pagina = 1) {
    	$total = CouchModel::getInstance()->countCouchsByTipoProvDescrip(array(
    			"idTipoCouch" => $idTipo,
    			"idProvincia" => $idProv,
    			"descripcion" => "%$descripcion%"
    	));
    	...
    	$couchinns = CouchModel::getInstance()->searchCouchsByTipoProvDescrip(array(
    			"idTipoCouch" => $idTipo,
    			"idProvincia" => $idProv,
    			"descripcion" => "%$descripcion%",
    			"limit" => $limit,
    ...
    public function ajax_searchCouchsAction(){
		...
		if ($idTipoCouch != '' && $idProvincia != '' && $idCiudad == '' && $descripcion == '') {
			$result = $this->paginador_process_searchTipoProvincia($idTipoCouch, $idProvincia, $pagina);
    		$nombreTipo = CouchModel::getInstance()->getNombreTipoCouch(array("idTipoCouch" => $idTipoCouch));
    		$nombreProv = CouchModel::getInstance()->getNombreProvincia(array("idProvincia" => $idProvincia));			
			if ($result ['couchinns']) {
				$data ['found'] = false;
				$data ['msj'] = "Resultados de la búsqueda por tipo de couch: <strong>".$nombreTipo ['nombre']."</strong> y por Provincia <strong>".$nombreProv['nombre']."</strong> ";
			} else {
				$data ['found'] = true;
				$data ['msj'] = "No hay resultados de búsqueda por tipo de couch: <strong>".$nombreTipo ['nombre']."</strong> y por Provincia <strong>".$nombreProv['nombre']."</strong> ";
			}
		}
    	 
    		//Si es por tipo, provincia y ciudad
		if ($idTipoCouch != '' && $idProvincia != '' && $idCiudad != '' && $descripcion == '') {
			$result = $this->paginador_process_searchTipoLugar($idTipoCouch, $idProvincia, $idCiudad, $pagina);
		    $nombreTipo = CouchModel::getInstance()->getNombreTipoCouch(array("idTipoCouch" => $idTipoCouch));
    		$nombreProv = CouchModel::getInstance()->getNombreProvincia(array("idProvincia" => $idProvincia));
    		$nombreCdad = CouchModel::getInstance()->getNombreCiudad(array("idCiudad" => $idCiudad));    		 
    		if($result['couchinns']){
    			$data['found'] = false;
    			$data['msj'] = "Resultado de búsqueda por tipo : <strong>".$nombreTipo['nombre']."</strong> en lugar: <strong>".$nombreCdad['nombre']." - ".$nombreProv['nombre']."</strong>";
    		}else {
    			$data['found'] = true;
    			$data['msj'] = "No hay resultados de búsqueda por tipo de couch: <strong>".$nombreTipo['nombre']."</strong> en lugar: <strong>".$nombreCdad['nombre']." - ".$nombreProv['nombre']."</strong>";
    		}
		}
		
    		//Si es por tipo y descripcion
    	if ($idTipoCouch != '' && $idProvincia == '' && $idCiudad == '' && $descripcion != ''){
    		$result = $this->paginador_process_searchTipoDescripcion($idTipoCouch, $descripcion, $pagina);
    		$nombreTipo = CouchModel::getInstance()->getNombreTipoCouch(array("idTipoCouch" => $idTipoCouch));
    		if($result['couchinns']){
    			$data['found'] = false;
    			$data['msj'] = "Resultados de la búsqueda por tipo de couch: <strong>".$nombreTipo['nombre']."</strong> y con descripcion: <strong> $descripcion</strong>";
    		}else {
    			$data['found'] = true;
    			$data['msj'] = "No hay resultados de búsqueda por tipo de couch: <strong>".$nombreTipo['nombre']."</strong> y con descripcion: <strong> $descripcion</strong>";
    		}
    	}
			
	    // Si es por tipo, provincia y descripcion
		if ($idTipoCouch != '' && $idProvincia != '' && $idCiudad == '' && $descripcion != '') {
			$result = $this->paginador_process_searchTipoProvDescrip( $idTipoCouch, $idProvincia, $descripcion, $pagina );
		    $nombreTipo = CouchModel::getInstance()->getNombreTipoCouch(array("idTipoCouch" => $idTipoCouch));
    		$nombreProv = CouchModel::getInstance()->getNombreProvincia(array("idProvincia" => $idProvincia));
			if ($result ['couchinns']) {
				$data ['found'] = false;
				$data ['msj'] = "Resultado de búsqueda por tipo de couch : <strong>" . $nombreTipo ['nombre'] . "</strong> en la Provincia: <strong>".$nombreProv ['nombre']."</strong> y con descripcion: <strong>$descripcion</strong>";
			} else {
				$data ['found'] = true;
				$data ['msj'] = "No hay resultados de búsqueda por tipo de couch: <strong>" . $nombreTipo ['nombre'] . "</strong> en la Provincia: <strong>".$nombreProv ['nombre']."</strong> y con descripcion: <strong>$descripcion</strong>";
			}
		}
			
		// Si es por provincia, ciudad y descripcion
		if ($idTipoCouch == '' && $idProvincia != '' && $idCiudad != '' && $descripcion != '') {
			$result = $this->paginador_process_searchProvCdadDescrip ( $idProvincia, $idCiudad, $descripcion, $pagina );
    		$nombreProv = CouchModel::getInstance()->getNombreProvincia(array("idProvincia" => $idProvincia));
    		$nombreCdad = CouchModel::getInstance()->getNombreCiudad(array("idCiudad" => $idCiudad));    		 
			if ($result ['couchinns']) {
				$data ['found'] = false;
				$data ['msj'] = "Resultado de búsqueda por lugar: <strong>" . $nombreCdad ['nombre'] . " - " . $nombreProv ['nombre'] . "</strong> y con descripcion: <strong>$descripcion</strong>";
			} else {
				$data ['found'] = true;
				$data ['msj'] = "No hay resultados de búsqueda por lugar: <strong>" . $nombreCdad ['nombre'] . " - " . $nombreProv ['nombre'] . "</strong> y con descripcion: <strong>$descripcion</strong>";
			}
		}
		
		// Si es por provincia y descripcion
		if ($idTipoCouch == '' && $idProvincia != '' && $idCiudad == '' && $descripcion != '') {
			$result = $this->paginador_process_searchProvDescrip ( $idProvincia, $descripcion, $pagina );
			$nombreProv = CouchModel::getInstance()->getNombreProvincia(array("idProvincia" => $idProvincia));
			if ($result ['couchinns']) {
				$data ['found'] = false;
				$data ['msj'] = "Resultado de búsqueda por Provincia: <strong>" . $nombreProv ['nombre'] . "</strong> y con descripcion: <strong>$descripcion</strong>";
			} else {
				$data ['found'] = true;
				$data ['msj'] = "No hay resultados de búsqueda por Provincia: <strong>" . $nombreProv ['nombre'] . "</strong> y con descripcion: <strong>$descripcion</strong>";
			}
		}
